...
path_commands["$HOME/Documents/zzz__PersonalProjects/ESP32/myProject"]="./build.sh debug real"
path_commands["$HOME/Documents/zzz__PersonalProjects/STM32/STMKernel/src"]="./build.sh debug real"
